...
class MetricsManager:
    ...
    def __init__(self) -> None:
        ...
        self.task_status_transition_total = Counter(
            ...
            labelnames=("from_status", "to_status", "agent"),
        )
    ...
    def on_task_routed(self, *, task_id: str, agent: str, route_source: str) -> None:
        """在任务完成路由后补全 agent/source 等关键信息。"""
        if not self.enabled:
            return
        with self._lock:
        ...
        self.tasks_started_total.labels(runtime.agent, runtime.route_source).inc()
    ...
    def on_task_finished(self, *, task_id: str, status: str) -> None:
        ...
        self.tasks_finished_total.labels(runtime.agent, final_status).inc()
        self.task_duration.labels(runtime.agent, final_status).observe(elapsed)
