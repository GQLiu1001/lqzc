...
class Settings:
    ...
    enable_llm_supervisor_router: bool = field(default_factory=lambda: os.getenv("ENABLE_LLM_SUPERVISOR_ROUTER", "true").lower() == "true")
    llm_supervisor_router_timeout_seconds: int = field(default_factory=lambda: int(os.getenv("LLM_SUPERVISOR_ROUTER_TIMEOUT_SECONDS", "12")))
